...
/**
 * Java通过银行卡号获取卡属银行（含校验） copy from https://blog.csdn.net/janwarlen/article/details/50216747
 */
public class BankCardCheck {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        String cardnumber= "621788 0800013818200";
        //获取cardName（由于卡bin库不全原因，cardName可能为null）
        String cardName = getname(cardnumber);
        //校验是否为信用卡
        boolean b = checkBankCard(cardnumber);

        System.out.println(cardName+b);
