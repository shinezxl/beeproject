 ...
 * copy from : https://blog.csdn.net/jingyangldp/article/details/55101633
 */
public class QrCode2 {
    ...
    public static String getLogoQRCode(String qrUrl,HttpServletRequest request,String productName)
    {
        ...
        String filePath = "F:\\soft\\tomcat\\apache-tomcat-7.0.86\\webapps\\geex-merchants-provider\\WEB-INF\\classes\\qrCode.jpg";  //TODO
        String content = qrUrl;
        try {
            QrCode2 zp = new QrCode2();
...
//            ImageIO.write(image, "png", new File("C:/TDC-" + new Date().getTime() + "test.png")); //TODO
            ImageIO.write(image,"jpg",new File("e:/new.jpg"));
//            String imageBase64QRCode =  Base64.byteArrayToBase64(baos.toByteArray());//因jar包原因
